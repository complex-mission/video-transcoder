...
[**公式サイト → tc.complexmission.com**](https://tc.complexmission.com)
...
> **一般ユーザー**：自分でビルドする必要はありません。[**公式サイト**](https://tc.complexmission.com) からすぐに使えるインストーラーをダウンロードしてください。
>
> **開発者 / ソースからビルドしたい方**：以下をお読みください。
